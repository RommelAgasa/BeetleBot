...
import { ActivityIndicator, Alert, FlatList, Linking, SafeAreaView, Text, TouchableOpacity, View, useWindowDimensions, } from "react-native";
...
export default function Index() {
  ...
  // ------------------- LOCAL STATES (replacing old hook UI states) ------------------- 
              ...
              >
                {settingsTab === "about" && (
                  <View>
                    ...
                    <Text>
                      Version 1.0.4{"\n"}Developed for controlling BLE-enabled cars via Bluetooth Low Energy.
                    </Text>
                    <Text style={{ marginTop: 10, fontWeight: "bold" }}>Facebook:</Text>
                    <Text
                      style={{ marginLeft: 10, color: "#1976d2" }}
                      onPress={() =>
                        Linking.openURL("https://www.facebook.com/share/g/18r6AjqyBG/")
                      }
                    >
                      Sorsogon Community Innovation Labs
                    </Text>
                    ...
                    <Text style={{ marginTop: 10, fontWeight: "bold" }}>Website:</Text>
                    <Text
                      style={{ marginLeft: 10, color: "#1976d2" }}
                ...
                {settingsTab === "help" && (
                  <View>
                    ...
                    <Text style={{ marginBottom: 10 }}>
                      <Text style={{ fontWeight: "bold" }}>Steering:</Text>
                      Use the steering wheel to control the car&apos;s direction (left, right, center).{"\n\n"}
                      <Text style={{ fontWeight: "bold" }}>Pedal Controls:</Text>{" "}
                      Accelerate, brake, and reverse using the pedal buttons. {"\n\n"}
                      <Text style={{ fontWeight: "bold" }}>Bluetooth:</Text>
                      Tap the Bluetooth icon to connect or disconnect from your BLE car.{"\n\n"}
                      ...
                      After changing settings, don&apos;t forget to tap{" "}
                      <Text style={{ fontWeight: "bold" }}>Save</Text> to apply and send updates to your car.{"\n\n"}
                    </Text>
                  </View>
                )}
                {settingsTab === "advanced" && (
                  <View>
                    ...
                    <Text style={{ fontWeight: "bold", fontSize: 16, marginBottom: 4, marginTop: 16 }}>
                      Command Mapping
                    </Text>
                    <Text style={{ marginBottom: 5 }}>
                    ...
                    >
                      {Object.entries(DEFAULT_COMMANDS)
                        .filter(([key]) => !["FL", "FR", "BL", "BR"].includes(key))
                        .map(([key, defVal]) => (
                          <View
                            key={key}
                            style={{
                    ...
                    <Text style={{ color: "#888", fontSize: 12, marginTop: 8 }}>
                      Note: If you change the command (e.g., from F to UP), make sure your Arduino code or device firmware is updated to recognize and respond to the new command.
                    </Text>
                  </View>
                )}
              </ScrollView>
